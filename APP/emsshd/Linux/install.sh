...
: > "$manifest"
printf 'emsshd package is ready at: %s\n' "$script_dir"
printf 'No init.d/systemd service is installed by default. Use init.d/S98emsshd or your system service manager if needed.\n'
