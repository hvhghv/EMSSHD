...
$items = @()
Write-Host "emsshd package is ready at: $packageDir"
Write-Host 'No Windows service is registered by default. Run bin\emsshd.exe directly or integrate it with your preferred service manager.'
