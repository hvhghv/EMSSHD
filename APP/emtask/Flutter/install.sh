...
: > "$manifest"
printf 'emtask client package is ready at: %s\n' "$script_dir"
printf 'No desktop entry or system integration is installed by default. Run the bundled executable manually or integrate it with your desktop environment.\n'
